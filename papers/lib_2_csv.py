...
Modified by M Kenworthy for single library use
...
if __name__ == '__main__':
 ...
 #   args = parser.parse_args()
    ...
    with open(output_file, 'w') as f:
        ...
        # Header of file
        f.write('#num_documents,bibcodes\n')

        f.write(
            '{num_documents},{bibcodes}\n'.format(
                num_documents=output['num_documents'][0],
                bibcodes='\t'.join(output['bibcodes'][0])
            )
        )
